...
var ColorObject = function () {
  this.color = [27, 160, 152]; // RGB with alpha
  this.color2 = [220, 220, 220];
  this.a = 50;
  this.bgColor = 2
};
...
function drawFunc() {
  ...
  for (let i = 0; i < symmetry; i++) {
    ...
    t += 0.0009; // Increment t for varying noise
...
function createGUI() {
  ...
  guiAdvanced.add(settings, 'frames').name('Frames/sec').min(22).step(4).max(120).onChange(settings.resetVar);
